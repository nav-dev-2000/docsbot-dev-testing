...
export function Hero() {
  return (
    <Container className="pt-8 pb-28 text-center lg:pt-20">
      ...
      <h1 className="mx-auto max-w-4xl font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <div>
        <span className="inline-block text-transparent bg-clip-text bg-gradient-to-br from-red-400 to-blue-800">
      <ReactRotatingText
      items={types}
      emptyPause={200}
      pause={2000}
    ...
    /></span> visualization
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative text-transparent bg-clip-text bg-gradient-to-br from-blue-600 to-blue-900">reimajinned</span>
        </span>{' '}
        with fine-tuned AI.
      </h1>
