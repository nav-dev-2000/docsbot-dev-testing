...
import { canUserEditBot, canUserExportBotLogs } from '@/utils/function.utils'
...
const Answer = ({
    ...
    const usedSourcesCount =
        question.sources?.filter((s) => s?.used).length || 0
...
export default function TableQuestions({
        ...
        const options = [
            {
                ...
                options: [
                    { value: null, label: 'All' },
                    {
                        ...
                        label: (
                            <span className="flex items-center">
                                <HandThumbUpIcon className="mr-1 h-4 w-4 text-green-600" />{' '}
                                Up
                            </span>
                        ),
                    },
                    ...
                    },
                    {
                        ...
                        label: (
                            <span className="flex items-center">
                                <HandThumbDownIcon className="mr-1 h-4 w-4 text-red-600" />{' '}
                                Down
                            </span>
                        ),
                    },
            ...
            },
            {
                ...
                options: [
                    { value: null, label: 'All' },
                    {
                        ...
                        label: (
                            <span className="flex items-center">
                                <LifebuoyIcon className="mr-1 h-4 w-4 text-blue-700" />{' '}
                                Escalated
                            </span>
                        ),
                    },
                    {
                        ...
                        label: (
                            <span className="flex items-center">
                                <LifebuoyIcon className="mr-1 h-4 w-4 text-gray-500" />{' '}
                                Not Escalated
                            </span>
                        ),
                    },
        ...
        options.push({
            ...
            options: [
                ...
                },
                {
                    ...
                    label: (
                        <span className="flex items-center">
                            <MinusCircleIcon className="mr-1 h-4 w-4 text-red-600" />{' '}
                            Not Answered
                        </span>
                    ),
                },
    ...
    const blurEnabled = useMemo(() => {
        if (!questions?.questions || !questions?.pagination) return false
        return (
                ...
                <div className="px-0">
                    <div className="mb-4">
                            ...
                            {lastSearchedQuery && (
                                ...
                                >
                                    ...
                                    <span className="m-auto flex pl-1 text-xs text-gray-400">
                                        ...
                                        {lastSearchedQuery.length > 30
                                            ? `${lastSearchedQuery.substring(0, 30)}...`
                                            : lastSearchedQuery}
                                    </span>
                                </button>
                            )}
                        ...
                        <p className="mt-2 text-sm text-gray-700">
                            A log of questions and lookup answers you or users
                            have asked your bot in the last 90 days. Does not
                            include non-question messages, which are available
                            in the{' '}
                            <Link
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex flex-wrap items-center gap-4 sm:justify-end sm:gap-2 md:gap-4">
                                        ...
                                        <div className="flex">
                                            <div className="-mr-px grid grow grid-cols-1 focus-within:relative">
                                                <input
                                                    ...
                                                    className={clsx(
                                                        'col-start-1 row-start-1 block w-full min-w-0 rounded-l-lg border-0 bg-white py-2.5 pl-12 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-cyan-600 sm:pl-11 sm:text-sm/6',
                                                        localSearchInput
                                                            ? 'pr-8'
                                                            : 'pr-4',
                                                    )}
                                            ...
                                            <button
                                                type="button"
                                                className="flex shrink-0 items-center rounded-r-lg border-0 bg-white px-3 py-2 text-sm font-semibold text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 hover:bg-gray-50 focus:relative focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-cyan-600 disabled:opacity-50"
                                ...
                                <div className="light w-full overflow-visible sm:w-auto">
                                    <Datepicker
                                        value={dateRange}
                                        primaryColor="cyan"
                                        ...
                                        <div className="max-w-3xl rounded-lg bg-white/90 p-8 text-center shadow-lg backdrop-blur-sm">
                                            <Checkout team={team}>
                                                ...
                                                <p className="mb-8 text-center text-gray-700">
                                                    ...
                                                    or higher to unlock the full
                                                    chat history of your users
                    ...
                    <div
                        className={clsx(
                            'mt-6 flex justify-center md:justify-end',
                            searching && 'pointer-events-none opacity-50',
                        )}
                    >
                        <Paginator
