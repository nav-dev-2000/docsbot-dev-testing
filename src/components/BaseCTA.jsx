...
export default function BaseCTA({ setOpen }) {
  return (
    <button
      type="button"
    ...
    >
      ...
      <span className="mt-2 block text-sm font-medium text-gray-900">Create a new base</span>

      <p className="mt-1 text-sm text-gray-500">
        Train a new knowledge base with your own documentation and content.
      </p>
    </button>
  )
}
