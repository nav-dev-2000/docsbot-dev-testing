  ...
  return (
      <div
        className={clsx(
          ...
          'rounded-lg border border-cyan-100',
          'bg-gradient-to-b from-cyan-50 via-white to-indigo-50',
          className,
        )}
      >
        <div className="flex flex-col-reverse gap-6 p-6">
          ...
          {croppedImage && (
            <Link
              href={fullReportUrl}
              className="relative isolate w-full overflow-hidden rounded-t-xl lg:rounded-xl lg:rounded-b-none transition hover:-translate-y-0.5 hover:scale-[0.99]"
            >
              <img
                src={croppedImage}
