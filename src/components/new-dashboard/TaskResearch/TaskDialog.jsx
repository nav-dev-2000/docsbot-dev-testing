...
const TaskDialog = ({
    ...
    description = 'Are you sure you want to delete this deep research task? This action cannot be undone.',
    confirmLabel = 'Delete',
    cancelLabel = 'Cancel',
}) => {
            ...
            >
                ...
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative w-full max-w-md transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:p-6">
