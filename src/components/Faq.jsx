...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes! We have a generous affiliate program that pays out 25% of the revenue from any customer you refer to us for the first 12 months of their account. This includes plan upgrades, and can provide as much as a $3,000 commission per referral! We provide a 60 day cookie and 60 day payout schedule via PayPal. You can signup here: https://affiliates.uglyrobot.com/signup?campaign=docsbot-ai.",
  },
]
