...
import jpaHealthLogo from '@/images/logos/jpa-health-logo.png'
import sonyLogo from '@/images/logos/logo-sony.svg'

const caseStudies = [
  {
    logo: jpaHealthLogo,
    logoAlt: 'JPA Health logo',
    headline: 'Healthcare',
    client: 'JPA Health + DocsBot',
    quote:
      '“Over 90% of chatbot queries originated from agents JPA developed, reducing the need for direct human interaction and streamlining internal decision-making.”',
    link: 'https://docsbot.ai/article/jpa-health-ai-powered-healthcare-communications',
  },
  {
    logo: sonyLogo,
    logoAlt: 'Sony logo',
    ...
    quote:
      '“Within just one month of deployment, DocsBot successfully handled over 30,000 inquiries with an ~80% resolution rate.”',
