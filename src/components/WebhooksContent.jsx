...
export default function WebhooksContent({ team, bot, preWebhooks = [] }) {
  ...
  useEffect(() => {
    if (!preWebhooks?.length) {
      loadWebhooks()
    }
  }, [preWebhooks?.length, loadWebhooks])
        ...
        >
              ...
              <div className="flex gap-3">
                ...
                <div className="text-sm/6">
                  ...
                  >
                    ...
                    <Link
                      href={`/app/bots/${bot.id}/widget/content`}
                      className="text-cyan-600 underline hover:text-cyan-800"
                    >
                      widget settings
                    </Link>
          ...
          <div className="flex justify-end md:col-span-3">
            <button
              ...
              className="inline-flex items-center justify-center rounded-md border border-cyan-600 bg-cyan-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-700 hover:border-cyan-700 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
            >
