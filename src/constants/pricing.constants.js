...
export const featureDefinitions = {
  ...
  messagesPerMonth: { label: 'Messages / month', category: 'limits' },
  ...
  customButtons: {
    label: 'Custom action button (1x)',
    category: 'actions',
  },
  multipleCustomButtons: {
    label: 'Multiple custom action buttons',
    category: 'actions',
  },
  mcpRemoteConnectors: {
...
export const enterpriseFeatures = [
  ...
  'Custom remote MCP connector limits',
  'SOC 2 Type II',
  'GDPR compliant',
  'HIPAA available',
  'Custom DPA',
