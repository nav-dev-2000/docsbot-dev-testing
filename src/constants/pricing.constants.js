...
export const featureDefinitions = {
  ...
  bookingActions: { label: 'Scheduling tools', category: 'features' },
  webSearch: { label: 'Web search', category: 'features' },
  leadCollection: { label: 'Lead collection forms', category: 'features' },
  leadCollectionCustomFields: {
    label: 'Custom lead fields (beyond name/email)',
    category: 'features',
  },
  escalationTickets: { label: 'Escalation ticket creation', category: 'features' },
  customButtons: {
  ...
  mcpServer: { label: 'MCP server', category: 'integrations' },
  stripeActions: { label: 'Stripe billing support actions', category: 'integrations' },
