...
export const featureDefinitions = {
  ...
  messagesPerMonth: { label: 'Messages per month', category: 'limits' },
  ...
  promptCustomization: { label: 'Prompt customization', category: 'customization' },
