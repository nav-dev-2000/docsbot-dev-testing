...
export const sourceTypes = [
  ...
  },
  {
    id: 'document',
    title: 'Document',
    description: 'Upload a document file containing text (Text, Office, PDF, HTML, EML, etc)',
    fullDescription: 'Upload a document file containing text to learn from. Some examples are product documentation, slide decks, research papers, employee handbooks, an ebook, or any content you can convert to a text file. We will parse the content, and add it to this knowledge base. Currently we support adding .txt, .docx, .pptx, .eml, .html, and .pdf documents.',
    ...
    fieldTitle: 'required',
    fieldFile: 'required',
    fileTypes: {txt: 'text/plain', docx: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', pptx: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', eml: 'message/rfc822', html: 'text/html', pdf: 'application/pdf'},
  },
  {
    id: 'wp',
    title: 'WordPress',
