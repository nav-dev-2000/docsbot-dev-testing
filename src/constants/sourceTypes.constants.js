...
export const sourceTypes = [
   // Web
   {
    id: 'website',
    title: 'Website',
    description: 'Scan a website and select which pages to index.',
    fullDescription: 'Enter a website URL and we will scan the pages on the website. You can then select which pages or groups of pages to include in your bot. This is perfect for indexing entire websites or specific sections of a website. Note: Not every URL on the site may be detected this way.',
    icon: GlobeAltIcon,
    minPlan: 'free',
    isNew: true,
    coming: false,
    ...
    fieldImages: true,
    category: 'Web',
    instructionsUrl: '/documentation/doc/training-a-chatbot-from-website-mapping',
  },
  {
    id: 'url',
    title: 'Single URL',
  ...
  },
  {
    ...
    fullDescription: 'Upload a simple txt or csv file with a list of urls, or paste URLs directly. We will download all html pages in the list, parse the content, and add it to this bot index.',
    icon: QueueListIcon,
    minPlan: 'free',
    coming: false,
    fieldUrl: false,
  ...
  // Productivity
  {
    ...
    title: 'Document',
    description:
      'Upload document files containing text (Text, Office, PDF, HTML, MD, EML, ZIP, CSV, TSV, Images, SRT, etc)',
    fullDescription:
      'Upload a document file containing text to learn from. Some examples are product documentation, slide decks, research papers, employee handbooks, an ebook, or any content you can convert to a text file. We will parse the content, and add it to this bot. Currently we support adding .txt, .docx, .pptx, .md, .html, .pdf, .eml, .srt, .xlsx, .csv, and .tsv documents. For Excel, CSV, and TSV files, supports one table per sheet and the first row should contain the column headers. We also support .png, .jpeg, .gif, .webp, .heic, and .heif images for AI description and text extraction. Paid users can also add .zip files containing multiple documents!',
    icon: DocumentIcon,
    minPlan: 'free',
    isNew: false,
    coming: false,
