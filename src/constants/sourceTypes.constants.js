...
*/
  // Customer Support
  {
    ...
    fullDescription: 'Connect to Help Scout via our partner Truto to import recent closed tickets. We transform all ticket conversations into generic FAQs without personal information to answer future user questions. Please read our instructions for more information. (BETA)',
    icon: HelpScoutLogo,
    isTruto: 'helpscout',
    isNew: true,
    isPro: true,
  ...
  },
  {
    ...
    fullDescription: 'Connect to Freshdesk via our partner Truto to select and import Published articles or Tickets.',
    icon: FreshdeskLogo,
    isTruto: 'FRESHDESK',
    isPro: true,
    coming: true,
