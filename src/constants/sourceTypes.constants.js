...
export const sourceTypes = [
  ...
  },
  {
    ...
    fullDescription: 'Integrate with Confluence through our partner Truto, and effortlessly import content from all Confluence pages.',
    icon: ConfluenceLogo,
    isTruto: 'CONFLUENCE',
    isPro: true,
    coming: true,
...
*/
  // Customer Support
  {
    ...
    fullDescription: 'Connect to Zendesk via our partner Truto to select and import all Help Center articles or Tickets.',
    icon: ZendeskLogo,
    isTruto: 'ZENDESK',
    isPro: true,
    coming: true,
