const LLMS = [
  ...
  },
  {
    ...
    provider: 'mistral',
    description:
      'Mistral Large 3 is Mistral’s most capable open multimodal model to date, released on December 2, 2025. It uses a sparse Mixture-of-Experts architecture with 41B active parameters and 675B total parameters, supports a 256K context window, and is priced at $0.50 per million input tokens and $1.50 per million output tokens via Mistral Docs.',
    input_context_window: '256K',
    maximum_output_tokens: 'Unknown',
    open_source: true,
    ...
    knowledge_cut_off_date: 'Unknown',
    api_providers:
      'Mistral AI Studio, Amazon Bedrock, Azure AI Foundry, Hugging Face, IBM watsonx, OpenRouter, Fireworks, Together AI',
    input_cost_per_million_tokens: 0.5,
    output_cost_per_million_tokens: 1.5,
    modalities: {
      text: true,
  ...
  },
  {
    ...
    provider: 'mistral',
    description:
      'Mistral Medium 3.1 is Mistral’s frontier-class multimodal enterprise model, released on August 12, 2025. It improves tone and performance over Mistral Medium 3, supports a 128K context window, and is priced at $0.40 per million input tokens and $2.00 per million output tokens.',
    input_context_window: '128K',
    maximum_output_tokens: 'Unknown',
    open_source: false,
    ...
    knowledge_cut_off_date: 'Unknown',
    api_providers:
      'Mistral AI Platform, Amazon SageMaker, IBM watsonx, NVIDIA NIM, Azure AI Foundry, Google Cloud Vertex AI',
  ...
  },
  {
    ...
    provider: 'xai',
    description:
      "Grok 4.3 is xAI's recommended Chat API model and the current Grok flagship for text and image-input workflows. xAI describes it as the most intelligent and fastest Grok model it has built, with reasoning, function calling, structured outputs, a 1M-token API context window, prompt caching, and the grok-4.3-latest alias. It supersedes the Grok 4.20 beta line for most API callers while retaining server-side tool support for web search, X search, code execution, files, and remote MCP.",
    input_context_window: '1M',
    maximum_output_tokens: 'Unknown',
    open_source: false,
