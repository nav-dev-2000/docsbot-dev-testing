export const LLM_PRICING = {
  'Chat/Completion Models': [
    ...
    },
    {
      ...
      page_slug: 'claude-fable-5',
      context: '1M/128K',
      provider: 'Anthropic',
      input_token_cost_per_million: 10,
      cached_input_token_cost_per_million: 1,
      output_token_cost_per_million: 50,
    },
    {
      model_name: 'Claude Mythos 5',
      model_slug: 'claude-mythos-5',
      page_slug: 'claude-mythos-5',
      context: '1M/128K',
      provider: 'Anthropic',
      input_token_cost_per_million: 10,
      cached_input_token_cost_per_million: 1,
    ...
    },
    {
      ...
      context: '256K',
      provider: 'Mistral AI',
      model_slug: 'mistral-large-2512',
      page_slug: 'mistral-large-3',
      input_token_cost_per_million: 0.5,
      output_token_cost_per_million: 1.5,
    },
    {
      ...
      context: '128K',
      provider: 'Mistral AI',
      model_slug: 'mistral-medium-2508',
      page_slug: 'mistral-medium-3-1',
    ...
    },
    {
      ...
      page_slug: 'mistral-medium-3-5',
      input_token_cost_per_million: 1.5,
      output_token_cost_per_million: 7.5,
    },
    {
