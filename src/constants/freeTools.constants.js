export const freeTools = [
  ...
  {
    name: 'Ask AI',
    description: 'Ask AI questions online for free',
    href: '/tools/productivity/ask-ai',
    ogImage: '/images/og/ask-ai.png',
    category: 'Productivity',
  },
  {
    name: 'AI Answer Generator',
    description: 'Generate instant answers with AI',
    href: '/tools/productivity/ai-answer-generator',
    ogImage: '/images/og/ai-answer-generator.png',
    category: 'Productivity',
  },
  {
    name: 'PDF Summarizer',
    description: 'Summarize your PDF with AI',
    href: '/tools/productivity/pdf-summarizer',
  ...
  },
  {
    ...
    href: '/tools/productivity/pdf-to-text',
