...
export default function FreeTools() {
  const uniqueCategories = ['Productivity']

  return (
    <>
      <NextSeo
        title="Free AI Productivity Tools - DocsBot AI"
        description="Explore our collection of free AI Productivity tools for streamlining your workflows."
        openGraph={{
          images: [
            {
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-6xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Boost your productivity with AI tools that help you generate, organize, and manage content faster. Ideal for students, professionals, and anyone looking to work smarter.
              </p>
            </div>
          </div>
        </div>
