...
{% callout title="Try our Advanced HelpScout Integration" %}
You can also enable our [advanced HelpScout integration](/docs/integrations/helpscout) to train your bot from your HelpScout support history and auto-reply to support tickets!
{% /callout %}
