...
const features = [
  {
    name: 'Support Docs',
    description:
      'Base your support docs in minutes with our crawler. No coding required. Just add your content and you are ready to go.',
...
const footerNavigation = {
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/UglyRobaseDev/',
      icon: (props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/uglyrobase/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>CraftChat AI - The WordPress docs chatbase</title>
        <meta
          name="description"
          content="I'm an AI chatbase that gives direct answers to your WordPress questions. I've been trained on all the official WordPress documentation and will do my best to answer your questions accurately and truthfully."
        />
      </Head>
              ...
              >
                <div className="flex flex-1 items-center">
                  <div className="flex w-full items-center justify-between md:w-auto">
                    <Link href="/">
                      <span className="sr-only">CraftChat</span>
                      <Image
                ...
                <Link
                href="https://www.producthunt.com/posts/chatwp-the-wordpress-docs-chatbase?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-chatwp&#0045;the&#0045;wordpress&#0045;docs&#0045;chatbase"
                target="_blank"
              >
                <img
                  src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=379055&theme=neutral"
                  alt="ChatWP&#0032;&#0045;&#0032;The&#0032;WordPress&#0032;Docs&#0032;Chatbase - Get&#0032;direct&#0032;answers&#0032;to&#0032;your&#0032;WordPress&#0032;questions&#0032;for&#0032;free&#0033; | Product Hunt"
                    ...
                    <div className="lg:py-24">
                      <h1 className="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                        ...
                        <span className="block bg-gradient-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-4xl text-transparent sm:pb-5 sm:text-5xl">
                          Your documention chatbase
                        </span>
                      </h1>
                      <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                        I'm an AI chatbase that gives direct answers to your
            ...
            <div className="relative bg-white pt-16 pb-12 sm:pt-24 lg:pt-32">
              <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
                ...
                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                  Custom chatbases made easy with a simple API
                </p>
                <p className="mx-auto mt-5 max-w-7xl text-xl text-gray-500">
                  Imagine having the power to build your own custom chatbase for
                  ...
                  your own Q&A and chatbases from your data that can be integrated into
            ...
            <div className="mx-auto max-w-md px-6 pt-12 sm:max-w-7xl lg:px-8 lg:pt-16">
              <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                <div className="space-y-8 text-left xl:col-span-1">
                  ...
                  <p className="text-base text-gray-500">
                    An <Link href="https://uglyrobase.com">UglyRobase</Link>{' '}
                    experiment
                  </p>
              ...
              <div className="mt-12 border-t border-gray-200 py-8">
                <p className="text-base text-gray-400 xl:text-center">
                  &copy; 2023 UglyRobase, LLC. All rights reserved.
                </p>
              </div>
            </div>
          </footer>
