...
import { ChevronLeftIcon, CodeBracketSquareIcon, XMarkIcon } from '@heroicons/react/24/outline'
...
function Widget({ team, bot }) {
  ...
  const [previewOptions, setPreviewOptions] = useState(bot)
  ...
  }, [color, icon, botIcon, branding, supportLink, showButtonLabel, labels, hideSources])
...
<script type="text/javascript">
  ...
  return (
    <DashboardWrap page="Bots" title={title} team={team} fullWidth={true}>
      <WidgetPreview teamId={team.id} botId={bot.id} options={previewOptions} />
      ...
      <div className="overflow-hidden bg-white shadow sm:rounded-lg mr-36">
              ...
              <div className="divide-y divide-gray-200 px-4 sm:px-6">
                <div className="space-y-6 pb-5 pt-6">
                  ...
                  <div className="flex flex-col justify-between space-y-4 sm:flex-row sm:space-x-8 sm:space-y-0">
                    <div className="w-full">
                      ...
                      <span className="text-sm text-gray-500">
                        This link will appear after the bot replies. Optional, leave blank to hide.
                      </span>
                      <div className="mt-1">
                        <input
                          type="text"
                  ...
                  <div className="w-full">
                    ...
                    <span className="text-sm text-gray-500">
                      This text will appear as the first message from the bot displayed to the user.
                      Supports{' '}
                  ...
                  <div className="w-full">
                    ...
                    <span className="text-sm text-gray-500">
                      Enter a comma-separated list of domains that are allowed to embed this widget.
                      Any subdomains must be listed seperately. Leave blank to allow all domains.
                    </span>
                    <div className="mt-1">
                      <input
                        type="text"
